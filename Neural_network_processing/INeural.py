...
def image_to_image(init_img_binary_data: bytes, caption: str, params: dict) -> List[bytes]:
    ...
    if params["version"] == "SD-2.0":
        ...
        binary_data_list = Kandinsky2_image_to_image(init_img_binary_data, prompt, params)
    else:
...
def stylization(content_binary_data: bytes, style_binary_data: bytes, prompt: str, params: dict) -> List[bytes]:
    ...
    binary_data_list = Kandinsky2_stylization(content_binary_data, style_binary_data, prompt, params)
    return binary_data_list
